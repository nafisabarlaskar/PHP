<?php
class Helper_PaypalIpnAction extends Zend_Controller_Action_Helper_Abstract
{
    ...
    const charset = 'utf-8';
        ...
        {
        	//Zend_Registry::get('logger')->err('inside paypal helper');
                // Validate
    ...
    function direct(array $post_data)
    {        
        return $this->process($post_data); 
    }
